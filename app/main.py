...
# Import routers
from app.api import operators, deals, principals, documents, underwriting, memos, webhooks, deal_notes, pending_emails, sponsor_notes, sponsor_assessments
...
app.include_router(pending_emails.router, prefix="/api", dependencies=auth_deps)
app.include_router(sponsor_notes.router, prefix="/api", dependencies=auth_deps)
app.include_router(sponsor_assessments.router, prefix="/api", dependencies=auth_deps)
